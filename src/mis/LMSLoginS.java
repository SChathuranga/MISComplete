...
public class LMSLoginS extends JFrame {
	...
	public LMSLoginS() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(LMSLoginS.class.getResource("/Resources/Custo.Man.Christmas.Folder.Library.ico.png")));
				...
				if(e.getKeyCode()==KeyEvent.VK_ENTER)
				{
					...
					else
					{
						try
						{
							...
							while(rs.next())
							{
								String Query1 = "select * from StudentsMF where RegNo=?";
								PreparedStatement pst1 = connection.prepareStatement(Query1);
								pst1.setString(1, txtRegNo.getText());
								ResultSet rs1 = pst1.executeQuery();
								while(rs1.next())
								{
									byte[] img = rs1.getBytes(20);

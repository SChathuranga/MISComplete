...
public class MIS_LoginTeacher extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
					MIS_LoginTeacher frame = new MIS_LoginTeacher();
	 ...
	 * Create the frame.
	 */
	public MIS_LoginTeacher() {
		connection=DBConnector.dbConnector();
		setIconImage(Toolkit.getDefaultToolkit().getImage(MIS_LoginTeacher.class.getResource("/Resources/Custo.Man.Christmas.Folder.Library.ico.png")));
			...
			public void keyPressed(KeyEvent e) {
				if(e.getKeyCode()==KeyEvent.VK_ENTER)
				{
					...
					else
					{
						try
						{
							String Query = "select * from TeachersMF where RegNo=? and Password=?";
							...
							while(rs.next())
							{
								...
								try {
									...
									frame.lblTID.setText(rs.getString(1));
									frame.lblTName.setText(rs.getString(2));

...
public class AdminViewHistory extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminViewHistory frame = new AdminViewHistory();
	 ...
	 * Create the frame.
	 */
	public AdminViewHistory() {
		connection = DBConnector.dbConnector();
		setIconImage(Toolkit.getDefaultToolkit().getImage(AdminViewHistory.class.getResource("/Resources/Custo.Man.Christmas.Folder.Library.ico.png")));
		...
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try
				{
					...
					String Query = "select * from LibHistory";
